...
export default function DeviceSetupPage() {
      ...
      <main className="container" style={{ maxWidth: '600px', marginTop: '10vh' }}>
        <article style={{ textAlign: 'center', padding: '2rem' }}>
          <header style={{ marginBottom: '2rem' }}>
            <h1 style={{ marginBottom: '0.5rem' }}>Authorize Kitchen Display</h1>
  ...
  return (
    <main className="container" style={{ maxWidth: '500px', marginTop: '15vh' }}>
      <article style={{ textAlign: 'center', padding: '2rem' }}>
        <header style={{ marginBottom: '2rem' }}>
          <h1 style={{ marginBottom: '0.5rem' }}>DarkVelocity KDS</h1>
          <p style={{ color: 'var(--pico-muted-color)' }}>Kitchen Display System</p>
        </header>

        <p style={{ marginBottom: '2rem' }}>
          This display needs to be authorized before it can show kitchen orders.
        </p>
